"""
NgFileManager - Backend API
File manager with upload, preview, folder tree, and sharing
"""
...
app = FastAPI(
    title="NgFileManager",
    description="File manager with upload, preview, folder tree, and sharing",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "NgFileManager"}
